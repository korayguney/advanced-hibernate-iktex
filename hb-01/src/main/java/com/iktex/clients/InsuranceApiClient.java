...
public class InsuranceApiClient {
    ...
    private static void persistTestData() {
        Address address1 = new Address("detail...");
        Address address2 = new Address("detail2...");
        ...
        Customer customer3 = new Customer("Hasan", "Simsek", address1, 4444444L, 777654643563L);

        address1.setCustomer(customer1);
        address1.setCustomer(customer2);
        address2.setCustomer(customer3);
